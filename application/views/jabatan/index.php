  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_title">Jabatan</h5>
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          <input type="hidden" value="" name="idjabatan" />
          <div class="form-body">
            <div class="form-row">
              <div class="col-md-12 col-xs-12">
                <div class="form-group">
                  <label class="control-label">Nama Jabatan</label>
                  <input name="nmjabatan" placeholder="Nama Jabatan" class="form-control" type="text">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    //DataTable
    table = $('#jabatan_list').DataTable({
      "processing": true,
      "serverSide": true,
      "order": [],
      "ajax": {
        "url": "<?= base_url('jabatan/list') ?>",
        "type": "POST"
      },
      "columnDefs": [{
        "targets": [-1],
  ...
  function edit_data(id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $('[name="nmjabatan"]').val(data.nmjabatan);
