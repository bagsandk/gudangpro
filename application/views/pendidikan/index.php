  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_title">Pendidikan</h5>
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          <input type="hidden" value="" name="idpendidikan" />
          <div class="form-body">
            <div class="form-row">
              <div class="col-md-12 col-xs-12">
                <div class="form-group">
                  <label class="control-label">Nama Pendidikan</label>
                  <input name="nmpendidikan" placeholder="Nama Pendidikan" class="form-control" type="text">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    //DataTable
    table = $('#pendidikan_list').DataTable({
      "processing": true,
      "serverSide": true,
      "order": [],
      "ajax": {
        "url": "<?= base_url('pendidikan/list') ?>",
        "type": "POST"
      },
      "columnDefs": [{
        "targets": [-1],
  ...
  function edit_data(id) {
    ...
    $.ajax({
      url: "<?= base_url('pendidikan/edit/') ?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        $('[name="idpendidikan"]').val(data.idpendidikan);
        $('[name="nmpendidikan"]').val(data.nmpendidikan);
  ...
  function delete_data(id) {
    Swal({
      ...
      if (result.value) {
        ...
        $.ajax({
          url: "<?= base_url('pendidikan/delete') ?>/" + id,
          type: "POST",
          dataType: "JSON",
          success: function(data) {
            reload();
