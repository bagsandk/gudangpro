  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="card-title text-center">Unit</h4>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modal_title">Unit</h5>
      ...
      <div class="modal-body form">
        <form action="#" id="form" class="form-horizontal">
          <input type="hidden" value="" name="idunit" />
          <div class="form-body">
            <div class="form-row">
              <div class="col-md-12 col-xs-12">
                <div class="form-group">
                  <label class="control-label">Nama Unit</label>
                  <input name="nmunit" placeholder="Nama Unit" class="form-control" type="text">
...
<script type="text/javascript">
  ...
  function edit_data(id) {
    ...
    $.ajax({
      url: "<?= base_url('unit/edit/') ?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data) {
        $('[name="idunit"]').val(data.idunit);
        $('[name="nmunit"]').val(data.nmunit);
